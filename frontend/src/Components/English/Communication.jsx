...
export const Automotives = [
    {
        ...
        plantype: "Communications",
       
        short: 'Partner with our team for software solutions that power smart networks, speed time to market and drive business-to-vertical industry capabilities.',
        
    },
    {
        plantype: "Media & Entertainment",
        short:'Drive growth through optimized content value chains, superior experiences and maximized monetization opportunities.'
    ...
    },
    {
      ...
      short: 'Generate insights you can monetize. Partner with our team to modernize data and create platforms that deliver a compelling CX.'       
    },
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${communication})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
...
<p>Is your data making money? By engineering personalized CX and streamlining operations, your organization can open new opportunities to monetize insights and deliver bottom-line results.</p>                                </div>
                            </Col>
