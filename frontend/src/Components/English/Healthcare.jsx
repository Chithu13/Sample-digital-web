...
export const Automotives = [
    {
     ...
     short: 'Ready to deliver greater value? We help implement process improvements, increase innovation and prepare you for the future.'        
    },
    {
        plantype: "Pharmacy benefit managers",
      
   short:'Our services include regulatory compliance solutions, clinical management programs, business intelligence systems and implementation advice.'       
    },
    {
        plantype: "Providers",
       
short:'Our innovative services and solutions help your organization deliver coordinated, quality care and improve financial performance.'       
    },
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${health})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}
>
                    <Container>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The healthcare segments we serve
                        </h3>
