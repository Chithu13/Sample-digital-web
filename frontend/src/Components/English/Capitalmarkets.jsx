...
export const Automotives = [
    {
        ...
        plantype: "Asset management",
        
       
        short: 'Our teams offer guidance in strategies and innovative solutions to address shifting investor demands.',
    ...
    },
    {
        ...
        short: 'Strategy and holistic end-to-end solutions for the digital future of investment.',
        
       
    },
    {
        plantype: "Investment banking",
       
        short: "Frameworks and solutions to address efficiency, regulatory and operational issues across the front, middle and back office, for the entire securities value chain."
    },
    {
        plantype: "Market information providers",
       
short: "Our expertise and partnerships enable providers to generate new insights for clients—and to monetize data for new revenue streams."        
    }
...
export const Automotivestype = [
    {
      ...
      short:"Enable technology and performance scalability, index operations and investor services."      
    },
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${capital})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}
>
                    <Container>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The capital markets segments we serve
                        </h3>
