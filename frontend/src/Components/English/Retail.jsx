...
export const Automotives = [
    {
        ...
        plantype: "Department stores",
       
 short:'Maximize customer service and profits and meet changing demands amid increased competition and complex supply chains.'        
    },
    {
        plantype: "Discount stores",
      
short:'Optimize merchandising, increase supply chain efficiency and generate product mix forecasts for better retention.'       
    },
    {
        plantype: "Grocery stores",
       
short:'Adjust prices, fine-tune inventory planning and deploy next generation point of sale systems to enhance the customer experience.'       
    },
    {
        plantype: "Specialty retailers",
       
short:'Embrace the future of shopping by delivering concepts and solutions for in-store selling through social networks.'        
    }
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${retail})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
                        <div className="listul">
                            ...
                            <h3>DELIVER MODERN RETAIL EXPERIENCES</h3>
...
<p>The pace of change across retail is dramatic, with far more sales happening online. Cognizant research shows retailers with exceptionally strong revenue growth derive a higher percentage of sales from digital channels. The digital mandate is here and there is no time for delay.</p>                                </div>
                            </Col>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The retail segments we serve
