...
import oil from "../../Assets/images/oilandgas.jpg"
...
export const Automotives = [
 ...
 short:'Expert Digital Web upstream services unlock new business value while exceeding current operational needs.'        
    },
    {
        plantype: "Midstream",
      
   short: 'Our solutions leverage the latest digital capabilities, from remote surveillance to commodity trading analytics.'       
    },
    {
        plantype: "Downstream",
        short: 'Expert Digital Web digital offerings help refinery operators, distributors and retailers generate new value and growth.'
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${oil})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}
>
                    <Container>
                        <div className="listul">
                            ...
                            <h3>UPSTREAM, MIDSTREAM, DOWNSTREAM SERVICES</h3>
...
<p>With the emergence of alternative energy sources and environmental concerns escalating, the oil and gas industry is turning to digital to deliver more energy options, reduce cost and provide higher customer satisfaction.</p>                                </div>
                            </Col>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The oil & gas segments we serve
                        </h3>
