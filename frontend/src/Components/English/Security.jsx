...
export const ApplicationService = [
    {
        ...
        middle: "Threat and Vulnerability Management",
        dis: "With Expert Digital Web Security’s suite of Threat and Vulnerability Management services, you can test for and manage vulnerabilities across your network, systems and applications—helping you mitigate risk and improve resilience. Address today’s challenges and prepare for the future by identifying existing and emerging threats and vulnerabilities that could disrupt your journey."
    ...
    },
    {
        ...
        middle: "Identity and Access Management",
        dis: "As you shift to a digital business model and expand your adoption of cloud, ensuring identities and controlling access have never been more important as legacy solutions become obsolete. With Expert Digital Web Security’s Identity and Access Management, you can deploy an agile solution that is highly scalable and hardens your cyber defenses"
    ...
    },
    {
        ...
        middle: "Data Security",
        dis:"Every day your company is generating vast amounts of data, and securing every bit of it is critical to the success of your organization. Our portfolio of trusted and scalable professional and managed data security services helps enterprises protect their critical data from cradle to grave in a cost-effective and compliant way with flexible, scalable and highly adaptable encryption and tokenization solutions."
    },
    {
        url: "M344.381,143.771C254.765,56.017,102.37,103.776,79.825,227.7c-31.849,4.598-59.138,25.445-72.018,55.076    c-0.016,0.035-0.032,0.07-0.047,0.107c-26.687,61.602,18.784,130.232,85.51,130.232h282.267    c75.246,0,136.463-61.216,136.463-136.462C512,189.241,430.314,123.682,344.381,143.771z M375.537,381.12H93.271    c-69.246,0-84.534-98.263-18.714-119.456c14.753-4.65,43.01-7.348,74.38,21.892c6.464,6.024,16.586,5.667,22.61-0.794    c6.024-6.464,5.668-16.586-0.794-22.61c-17.93-16.712-38.071-27.33-58.484-31.453c22.034-99.077,147.374-131.851,215.247-56.305    c4.189,4.661,10.714,6.451,16.693,4.57c67.272-21.117,135.795,29.374,135.795,99.69    C480.005,334.256,433.141,381.12,375.537,381.12z",
        middle: "Governance, Risk and Compliance",
        dis: "Expanding digital enterprises face complex governance and compliance requirements. IT security risk is now a board-level concern, and meeting the minimum requirement is not enough. Expert Digital Web Security’s Governance, Risk and Compliance suite helps you assess current risks, verify adherence to standards"
        
    },
    {
        url: "M47.7 23.5h-10V5.2c0-1.6-.5-2-2-2H29V1.9C29 1 28.4.4 27.6.4c-.9 0-1.4.6-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.5-1.5-1.5-.8 0-1.4.7-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.6-1.4-1.6-.9 0-1.4.6-1.5 1.5v1.3H1.9C.5 3.1 0 3.6 0 4.9v42.9c0 1.4.5 1.9 1.9 1.9h40.4c4-.1 7.2-3.3 7.2-7.3V25.3c-.1-1.3-.7-1.8-1.8-1.8zm-24.5 5.7h-4.3c-2.4 0-4.4 1.8-4.4 4.2 0 1.6-.2 3.2.2 4.8.8 3.1 3.6 5.4 6.9 5.5h1.6c.4 1 .8 1.9 1.3 2.8H2.9V5.9h5.9v1.3c0 .9.6 1.6 1.4 1.6.9 0 1.5-.6 1.5-1.6V6h5.8v1.3c0 .8.6 1.5 1.4 1.5.8 0 1.5-.6 1.5-1.4V6h5.8v1.4c0 .9.6 1.5 1.4 1.5.8 0 1.4-.6 1.4-1.5V6h5.8v17.4H25c-1.1 0-1.7.6-1.7 1.7-.1 1.4-.1 2.7-.1 4.1zm0 2.9v8.7c-2.6.4-4.7-.7-5.5-2.9-.2-.6-.2-1.2-.3-1.8v-2.5c0-.8.6-1.4 1.3-1.5h4.5zM46.5 27v15.1c0 2.8-1.9 4.6-4.6 4.6H30.7c-2.7 0-4.5-1.8-4.5-4.5V26.4h20.3v.6zM13.1 11.9c-4 0-7.2 3.2-7.2 7.3 0 3.9 3.3 7.2 7.2 7.2 4 0 7.2-3.2 7.2-7.2.1-4.1-3.2-7.3-7.2-7.3zm0 11.5c-2.4 0-4.4-2-4.4-4.4 0-2.4 2-4.4 4.4-4.3 2.4 0 4.3 2 4.3 4.3.1 2.5-1.9 4.4-4.3 4.4zm10.1-10.1c0-.8.6-1.4 1.5-1.5h5.6c.9 0 1.5.6 1.5 1.4 0 .8-.6 1.4-1.5 1.4h-5.6c-.8.1-1.4-.5-1.5-1.3zm8.7 5.8c0 .8-.7 1.4-1.6 1.4h-5.5c-1 0-1.6-.6-1.6-1.4 0-.8.7-1.4 1.6-1.4h5.5c1 0 1.6.6 1.6 1.4zm4.4 24.7c3.9 0 7.2-3.3 7.2-7.3s-3.3-7.3-7.2-7.3c-4 0-7.3 3.3-7.3 7.3s3.4 7.3 7.3 7.3zm0-11.7c2.4 0 4.3 1.9 4.3 4.4 0 2.4-2 4.4-4.4 4.4-2.3 0-4.3-2-4.3-4.5.1-2.4 2-4.3 4.4-4.3z",
        middle: "Cloud Security",
        dis: "Migrating workloads, applications and data to the cloud? The advantages are clear, but security is often overlooked. Understanding your risk and compliance requirements, as well as the implications to applications and identities, is critical. Expert Digital Web provides the expertise to help you minimize the risks of cloud migration."
...
export const Security = () => {
    return (
        ...
        <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${security})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
                        <div className="listul">
                            ...
                            <h1>
                            Tackling today's top security challenges
                            </h1>
                        </div>
                    </Container>
                </div>
            ...
            <Container style={{ marginBottom: '130px'}}>
                <Row className="align-items-center">
                    <Col md={12}>
                       <h2 style={{fontWeight:"bold", fontSize:"3em"}}>Security for the age of digital everything

</h2><br></br>

<div style={{fontSize:"1.4em"}}>
<p>Eliminate security blind spots and accelerate innovation, transformation and growth.
</p><br></br>
<p>Outdated security solutions. Sophisticated cyberthreats. Increasing compliance requirements. Faced with these and other security challenges, today’s companies need a proactive partner who can anticipate and neutralize threats before they materialize..</p><br></br>
<p>
At Expert Digital Web, we approach security as the starting point for delivering the outcomes that leading global organizations demand. Our end-to-end security solutions combine deep domain and industry expertise with a future-focused approach that encompasses advisory, transformation and managed services. We offer the foresight and expertise to solve your most complex challenges
</p><br></br>
<p>By providing a 360-degree view of your organization’s security ecosystem, Expert Digital Web can identify and eliminate today’s blind spots—while also seeing and solving for the threats ahead—so you can accelerate business innovation, transformation and growth.</p>
</div>
                ...
                <Row>
                    <Col md={7} className="mx-auto">
                        <div className="smallheading text-center mb-5">
                            ...
                            <h4>End-to-end security solutions
</h4>
                            <p>
                            Expert Digital Web end-to-end security solutions combine deep domain and industry expertise. Our future-focused approach gives you the confidence of a secure environment, so you can move faster, be bolder and succeed into the future.                            </p>
                        </div>
                    </Col>
