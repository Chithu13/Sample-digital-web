...
import util from "../../Assets/images/utilities.jpg"
export const Automotives = [
    {

        plantype: "Electricity",
       
      short: 'Expert Digital Web electric utilities services leverage digital to improve efficiency, reduce costs and increase customer satisfaction.'       
    },

    {
        plantype: "Gas",
      
short:'We help gas companies find new growth by enhancing the customer experience, improving reliability and optimizing assets.'       
    },
    {
        plantype: "Water",
       
short: 'Our utilities practice has the industry and digital experience that water utilities need to create new business value.'       
    }
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${util})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
...
<p>Increasing reliance on new energy sources, along with a growing need for more efficiency, requires unprecedented operational agility—and investments in digital for traditional operators and new entrants alike.</p>                                </div>
                            </Col>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The utilities segments we serve
                        </h3>
