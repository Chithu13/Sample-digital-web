...
import lifescience from "../../Assets/images/lifesciences.jpg"
...
export const Automotives = [
    {
        ...
        plantype: "Medical devices",
       
short: 'Implement digital strategies and operations to improve product development, speed to market and patient centricity for increased profitability.'        
    },
    {
        plantype: "Pharmaceuticals and biotech",
      
 short:'Take advantage of intelligent digital platforms, cloud, data, automation and AI to develop safer, more effective and affordable drugs and improve patient outcomes. '       
    },
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${lifescience})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The life sciences segments we serve
                        </h3>
