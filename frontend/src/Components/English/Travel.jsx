...
export const Automotives = [
    {
        ...
        plantype: "Travel suppliers & intermediaries",
       
short:'Innovate to gain market share. Better serve the connected customer as you control travel spend and costs.'        
    },
    {
        plantype: "Restaurants & food services        ",
      
short:'Strengthen your brand and engage your customers in new ways. Become more efficient and customer-centric.'       
    },
    {
        plantype: "Real estate & property services        ",
       
short:'Transform real estate services and deliver real value to your customers. Improve time to market and reduce costs.'       
    },
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${travel})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The travel & hospitality segments we serve
                        </h3>
