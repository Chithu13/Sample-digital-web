...
export const Automotives = [
    {
        ...
        plantype: "Property & casualty",
        short: 'Streamline core processes and compete with digital startups. Simplify distribution, provide superior customer experiences and create lasting value.'
        
    },
    {
        plantype: "Life & annuity",
        short: 'Make your operating model more efficient. Accelerate underwriting, speed products to market and satisfy customers with sophisticated digital tools.'
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${insurance})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
...
<p>It’s an exciting time for the industry as more insurers invest to transform their business models. Because innovation is key to driving growth, we deliver insight that strengthens your digital presence, levels the field and achieves business vision.</p>                                </div>
                            </Col>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The insurance segments we serve
                        </h3>
