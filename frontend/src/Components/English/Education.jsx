...
export const Automotives = [
    {
        ...
        plantype: "Education providers",
       
       short: 'Expert Digital Web combines education sector domain knowledge with digital expertise to help schools, colleges and universities chart strategies and apply technology to improve student access, experiences and success. Our experience serving the broader education ecosystem make us uniquely positioned to help the education community navigate challenges such as declining enrollments, burdening fixed costs and re-imagining instructional technology.'        
    },
    {
        plantype: "Education publishers",
      
      short: 'Expert Digital Web works with the world’s top education publishers, helping them lead with digital-first products and content. We have proven experience transforming traditional businesses, products and operations designed for modern learning. Our services help improve profitability and de-risk investments in the platforms, products and programs offered by education publishers and enablers, alike.'       
    },
    {
        plantype: "Testing & assessment providers",
       
 short:'Expert Digital Web industry leading design thinking and digital engineering services help build end-to-end platforms for assessment authoring, delivering, proctoring and reporting to enhance the classroom experience or certification in a professional environment. Cognizant partners with clients to drive new experiences and modernize applications and infrastructure to transform into modern, agile and scalable organizations.'       
    },
]
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${education})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
...
<p>Digital-first connected learning paves the way to the future of higher education. Emerging technologies such as analytics, AI and machine learning will be key to hyper personalizing the student experience, helping to identify at-risk learners and provide the most effective support for each person.</p>                                </div>
                            </Col>
