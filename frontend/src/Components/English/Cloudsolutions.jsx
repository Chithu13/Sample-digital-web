...
export const ApplicationService = [
    {
        ...
        middle: "Core Infrastructure Management",
        dis:   "Large enterprises need to make their IT infrastructure and processes cloud ready today to reap the full benefits tomorrow. Core Infrastructure Management (CIM) is a broad offering that enables businesses to extract value from existing systems by modernizing technology, reimagining processes and transforming user experiences. From networking to data-center consolidation and hybrid cloud implementations, CIM encompasses a complete “cloud-smart” strategy. An agile IT infrastructure enables you to scale and adapt to changing needs. ",
    },
    {
    ...
    },
    {
        ...
        dis: "Expert Digital Web WorkNext Digital Workplace Services accelerate the move from traditional work environments to a completely modern workplace. Onboarding new users is quick and intelligent with self-healing software and adoptive self-service capabilities. Drive innovation in your business by tapping our extensive background in cloud workplace, AI/ML, analytics, modern collaboration, platform integrations and automation."
    },
...
export const Cloudsolutions = () => {
    return (
        ...
        <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full"  style={{backgroundImage:`url(${cloud})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}
>
                    <Container>
            ...
            <Container style={{ marginBottom: '130px'}}>
                <Row className="align-items-center">
                    <Col md={12}>
                       <h2 style={{fontWeight:"bold", fontSize:"3em"}}>Outcome-based cloud business solutions
</h2><br></br>

<div style={{fontSize:"1.4em"}}>
<p>Cloud solutions are the fastest and most effective way to innovate and run your business today. Respond and adapt immediately to changes in your industry with real-time reporting and customized, buyer-focused user experiences.
</p><br>
</br>
<p>Move processing power exactly where it’s needed by bringing all your IT resources into one secure cloud solution platform.</p><br></br>
</div>
