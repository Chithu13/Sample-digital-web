...
import { LeatestBlog, PlansConatiner, ProfileContainer } from "./HomeContainer_En"
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${manufacturing})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}
>
                    <Container>
...
<p>Analytics. Automation. Artificial intelligence. Smart factories. Integrated systems. With new digital skills and technologies, manufacturers can make business decisions based on real-time contextual data. It’s the biggest opportunity of the age, and we can help you make the transition.</p>                                </div>
                            </Col>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>Ensuring optimal results from technology investments and digital programs
                        </h3>
