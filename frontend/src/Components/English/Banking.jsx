...
export const Automotives = [
    {
        ...
        plantype: "Retail and commercial banking",
       
 short: 'Rebuild technology and operating models for the future. Create next-gen experiences for corporate customers and end-to-end experiences for retail customers that deliver more efficient operations and payments processes.'        
    },
    {
        plantype: "Lending",
        short: 'Keep the human factor in your lending processes. Achieve scale and stability with automated front and back offices.'
    ...
    },
    {
        ...
        short: 'Modernize core processes. Our enterprise strategies and designs help you increase throughput and improve risk and fraud management.',
    ...
    return (
        ...
        <Header_en/>
            <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${banking})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
...
<p>Maintaining your competitive advantage can be challenging when customers expect around-the-clock banking services. We help you streamline inefficient processes with strategies and solutions that grow your business and keep customers at the center of your organization.</p>                                </div>
                            </Col>
            ...
            <Row>
                <Col md={8} className="mx-auto">
                    <div className="smallheading text-center mb-5">
                        ...
                        <h3>The banking segments we serve
                        </h3>
