...
export const Intelligentprocess = () => {
    return (
        ...
        <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${intelligent})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
                        <div className="listul">
                            ...
                            <h1>
                            Turn automation advantage into human advantage
                            </h1>
                        </div>
                    </Container>
                </div>
            ...
            <Container style={{ marginBottom: '130px'}}>
                <Row className="align-items-center">
                    <Col md={12}>
                       <h2 style={{fontWeight:"bold", fontSize:"3em"}}>IPA: The future is now

</h2><br></br>

<div style={{fontSize:"1.4em"}}>
<p>Yesterday’s operating model won’t deliver tomorrow’s wins. Connect your processes, people and insights across the enterprise with intelligent process automation (IPA) for breakthrough performance at lower costs.</p><br></br>
<p>Our experts partner with you to design new ways of working that maximize the potential of automation. Together, we reimagine processes with human and digital intelligence to accelerate transformation and help your business sense the future.</p>
</div>
