...
import {  NewsLetters } from "./ServicesContainer_en"
 import application from "../../Assets/images/appliactionservices.png"
...
export const ApplicationService = [
    {
        ...
        middle: "Enterprise Application Development",
        dis:   "Stay ahead of the curve by building business-centric, tailored application portfolios with cutting-edge technologies through Expert Digital Web Smart Engineering platform ",
    ...
    },
    {
        ...
        middle: "Application Modernization",
        dis:   "Modernize applications, improve technical value, harness cloud-based development and develop your digital portfolio with our Expert Digital Web Modernization Acceleration Platform ",
    ...
    },
    {
        ...
        middle: "Application Management",
        dis: "Achieve the hyper-industrialization of application management and reduce operational expenses by up to 50% through intelligent automation and our proprietary, platform-based debt management strategy to fund modernization initiatives."
    },
    {
        url: "M344.381,143.771C254.765,56.017,102.37,103.776,79.825,227.7c-31.849,4.598-59.138,25.445-72.018,55.076    c-0.016,0.035-0.032,0.07-0.047,0.107c-26.687,61.602,18.784,130.232,85.51,130.232h282.267    c75.246,0,136.463-61.216,136.463-136.462C512,189.241,430.314,123.682,344.381,143.771z M375.537,381.12H93.271    c-69.246,0-84.534-98.263-18.714-119.456c14.753-4.65,43.01-7.348,74.38,21.892c6.464,6.024,16.586,5.667,22.61-0.794    c6.024-6.464,5.668-16.586-0.794-22.61c-17.93-16.712-38.071-27.33-58.484-31.453c22.034-99.077,147.374-131.851,215.247-56.305    c4.189,4.661,10.714,6.451,16.693,4.57c67.272-21.117,135.795,29.374,135.795,99.69    C480.005,334.256,433.141,381.12,375.537,381.12z",
        middle: "Expert Digital Web Applens",
        dis: "Expert Digital Web AppLens is an AI-based platform that uses intelligent, data-driven and context-based solutions to enable you to drive your application strategy end-to-end, increasing the lifespan and yield of your applications."
        
    },
    {
        url: "M47.7 23.5h-10V5.2c0-1.6-.5-2-2-2H29V1.9C29 1 28.4.4 27.6.4c-.9 0-1.4.6-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.5-1.5-1.5-.8 0-1.4.7-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.6-1.4-1.6-.9 0-1.4.6-1.5 1.5v1.3H1.9C.5 3.1 0 3.6 0 4.9v42.9c0 1.4.5 1.9 1.9 1.9h40.4c4-.1 7.2-3.3 7.2-7.3V25.3c-.1-1.3-.7-1.8-1.8-1.8zm-24.5 5.7h-4.3c-2.4 0-4.4 1.8-4.4 4.2 0 1.6-.2 3.2.2 4.8.8 3.1 3.6 5.4 6.9 5.5h1.6c.4 1 .8 1.9 1.3 2.8H2.9V5.9h5.9v1.3c0 .9.6 1.6 1.4 1.6.9 0 1.5-.6 1.5-1.6V6h5.8v1.3c0 .8.6 1.5 1.4 1.5.8 0 1.5-.6 1.5-1.4V6h5.8v1.4c0 .9.6 1.5 1.4 1.5.8 0 1.4-.6 1.4-1.5V6h5.8v17.4H25c-1.1 0-1.7.6-1.7 1.7-.1 1.4-.1 2.7-.1 4.1zm0 2.9v8.7c-2.6.4-4.7-.7-5.5-2.9-.2-.6-.2-1.2-.3-1.8v-2.5c0-.8.6-1.4 1.3-1.5h4.5zM46.5 27v15.1c0 2.8-1.9 4.6-4.6 4.6H30.7c-2.7 0-4.5-1.8-4.5-4.5V26.4h20.3v.6zM13.1 11.9c-4 0-7.2 3.2-7.2 7.3 0 3.9 3.3 7.2 7.2 7.2 4 0 7.2-3.2 7.2-7.2.1-4.1-3.2-7.3-7.2-7.3zm0 11.5c-2.4 0-4.4-2-4.4-4.4 0-2.4 2-4.4 4.4-4.3 2.4 0 4.3 2 4.3 4.3.1 2.5-1.9 4.4-4.3 4.4zm10.1-10.1c0-.8.6-1.4 1.5-1.5h5.6c.9 0 1.5.6 1.5 1.4 0 .8-.6 1.4-1.5 1.4h-5.6c-.8.1-1.4-.5-1.5-1.3zm8.7 5.8c0 .8-.7 1.4-1.6 1.4h-5.5c-1 0-1.6-.6-1.6-1.4 0-.8.7-1.4 1.6-1.4h5.5c1 0 1.6.6 1.6 1.4zm4.4 24.7c3.9 0 7.2-3.3 7.2-7.3s-3.3-7.3-7.2-7.3c-4 0-7.3 3.3-7.3 7.3s3.4 7.3 7.3 7.3zm0-11.7c2.4 0 4.3 1.9 4.3 4.4 0 2.4-2 4.4-4.4 4.4-2.3 0-4.3-2-4.3-4.5.1-2.4 2-4.3 4.4-4.3z",
        middle: "Expert Digital Web Lifecycle Engineering Acceleration Platform",
        dis: "Expert Digital Web Lifecycle Engineering Acceleration Platform is an AI-powered BOT-based platform that uses AI, ML and NLP techniques, and brings years of business, technology, functional experience and new technology archetypes to your development toolchain.."
        
    },
    {
        url: "M47.7 23.5h-10V5.2c0-1.6-.5-2-2-2H29V1.9C29 1 28.4.4 27.6.4c-.9 0-1.4.6-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.5-1.5-1.5-.8 0-1.4.7-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.6-1.4-1.6-.9 0-1.4.6-1.5 1.5v1.3H1.9C.5 3.1 0 3.6 0 4.9v42.9c0 1.4.5 1.9 1.9 1.9h40.4c4-.1 7.2-3.3 7.2-7.3V25.3c-.1-1.3-.7-1.8-1.8-1.8zm-24.5 5.7h-4.3c-2.4 0-4.4 1.8-4.4 4.2 0 1.6-.2 3.2.2 4.8.8 3.1 3.6 5.4 6.9 5.5h1.6c.4 1 .8 1.9 1.3 2.8H2.9V5.9h5.9v1.3c0 .9.6 1.6 1.4 1.6.9 0 1.5-.6 1.5-1.6V6h5.8v1.3c0 .8.6 1.5 1.4 1.5.8 0 1.5-.6 1.5-1.4V6h5.8v1.4c0 .9.6 1.5 1.4 1.5.8 0 1.4-.6 1.4-1.5V6h5.8v17.4H25c-1.1 0-1.7.6-1.7 1.7-.1 1.4-.1 2.7-.1 4.1zm0 2.9v8.7c-2.6.4-4.7-.7-5.5-2.9-.2-.6-.2-1.2-.3-1.8v-2.5c0-.8.6-1.4 1.3-1.5h4.5zM46.5 27v15.1c0 2.8-1.9 4.6-4.6 4.6H30.7c-2.7 0-4.5-1.8-4.5-4.5V26.4h20.3v.6zM13.1 11.9c-4 0-7.2 3.2-7.2 7.3 0 3.9 3.3 7.2 7.2 7.2 4 0 7.2-3.2 7.2-7.2.1-4.1-3.2-7.3-7.2-7.3zm0 11.5c-2.4 0-4.4-2-4.4-4.4 0-2.4 2-4.4 4.4-4.3 2.4 0 4.3 2 4.3 4.3.1 2.5-1.9 4.4-4.3 4.4zm10.1-10.1c0-.8.6-1.4 1.5-1.5h5.6c.9 0 1.5.6 1.5 1.4 0 .8-.6 1.4-1.5 1.4h-5.6c-.8.1-1.4-.5-1.5-1.3zm8.7 5.8c0 .8-.7 1.4-1.6 1.4h-5.5c-1 0-1.6-.6-1.6-1.4 0-.8.7-1.4 1.6-1.4h5.5c1 0 1.6.6 1.6 1.4zm4.4 24.7c3.9 0 7.2-3.3 7.2-7.3s-3.3-7.3-7.2-7.3c-4 0-7.3 3.3-7.3 7.3s3.4 7.3 7.3 7.3zm0-11.7c2.4 0 4.3 1.9 4.3 4.4 0 2.4-2 4.4-4.4 4.4-2.3 0-4.3-2-4.3-4.5.1-2.4 2-4.3 4.4-4.3z",
        middle: "Expert Digital Web Modernization Acceleration Platform",
        dis: "Expert Digital Web Modernization Acceleration Platform is a unified and comprehensive platform that defines and orchestrates your modernization strategy and execution by leveraging proprietary IPs and partner tools across the modernization lifecycle."
        
    },
    {
        url: "M47.7 23.5h-10V5.2c0-1.6-.5-2-2-2H29V1.9C29 1 28.4.4 27.6.4c-.9 0-1.4.6-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.5-1.5-1.5-.8 0-1.4.7-1.4 1.5v1.3h-5.8V1.9c0-.9-.6-1.6-1.4-1.6-.9 0-1.4.6-1.5 1.5v1.3H1.9C.5 3.1 0 3.6 0 4.9v42.9c0 1.4.5 1.9 1.9 1.9h40.4c4-.1 7.2-3.3 7.2-7.3V25.3c-.1-1.3-.7-1.8-1.8-1.8zm-24.5 5.7h-4.3c-2.4 0-4.4 1.8-4.4 4.2 0 1.6-.2 3.2.2 4.8.8 3.1 3.6 5.4 6.9 5.5h1.6c.4 1 .8 1.9 1.3 2.8H2.9V5.9h5.9v1.3c0 .9.6 1.6 1.4 1.6.9 0 1.5-.6 1.5-1.6V6h5.8v1.3c0 .8.6 1.5 1.4 1.5.8 0 1.5-.6 1.5-1.4V6h5.8v1.4c0 .9.6 1.5 1.4 1.5.8 0 1.4-.6 1.4-1.5V6h5.8v17.4H25c-1.1 0-1.7.6-1.7 1.7-.1 1.4-.1 2.7-.1 4.1zm0 2.9v8.7c-2.6.4-4.7-.7-5.5-2.9-.2-.6-.2-1.2-.3-1.8v-2.5c0-.8.6-1.4 1.3-1.5h4.5zM46.5 27v15.1c0 2.8-1.9 4.6-4.6 4.6H30.7c-2.7 0-4.5-1.8-4.5-4.5V26.4h20.3v.6zM13.1 11.9c-4 0-7.2 3.2-7.2 7.3 0 3.9 3.3 7.2 7.2 7.2 4 0 7.2-3.2 7.2-7.2.1-4.1-3.2-7.3-7.2-7.3zm0 11.5c-2.4 0-4.4-2-4.4-4.4 0-2.4 2-4.4 4.4-4.3 2.4 0 4.3 2 4.3 4.3.1 2.5-1.9 4.4-4.3 4.4zm10.1-10.1c0-.8.6-1.4 1.5-1.5h5.6c.9 0 1.5.6 1.5 1.4 0 .8-.6 1.4-1.5 1.4h-5.6c-.8.1-1.4-.5-1.5-1.3zm8.7 5.8c0 .8-.7 1.4-1.6 1.4h-5.5c-1 0-1.6-.6-1.6-1.4 0-.8.7-1.4 1.6-1.4h5.5c1 0 1.6.6 1.6 1.4zm4.4 24.7c3.9 0 7.2-3.3 7.2-7.3s-3.3-7.3-7.2-7.3c-4 0-7.3 3.3-7.3 7.3s3.4 7.3 7.3 7.3zm0-11.7c2.4 0 4.3 1.9 4.3 4.4 0 2.4-2 4.4-4.4 4.4-2.3 0-4.3-2-4.3-4.5.1-2.4 2-4.3 4.4-4.3z",
        middle: "Expert Digital Web Business Outcomes & Experience Dashboard",
        dis: "A customizable, single source of truth to improve business outcomes, Expert Digital Web Business Outcomes & Experience Dashboard  provides visibility into the health of your business processes using full-stack observability.",
...
export const ApplicationServices = () => {
    return (
        ...
        <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${application})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
                        <div className="listul">
                            ...
                            <h1>
                            Agile footing for business applications
                            </h1>
                        </div>
                    </Container>
                </div>
            ...
            <Container style={{ marginBottom: '130px'}}>
                <Row className="align-items-center">
                    <Col md={12}>
                       <h2 style={{fontWeight:"bold", fontSize:"3em"}}>Engineering applications for modern businesses
</h2><br></br>

<div style={{fontSize:"1.4em"}}>
<p>Accelerate modernization with software and platform-driven solutions.</p><br></br>
<p>Facing a new normal, today’s enterprises must modernize their business, fuel innovation and become more agile. That may require compressing years of change into months.</p><br></br>
<p>At Expert Digital Web, our application modernization services help you achieve agility for an increasingly digital world. Integrate a combination of accelerators, platforms and strategic partners to modernize core business applications. The result: An enterprise that’s ready for whatever the new normal has in store for you.
</p>
</div>
