...
import digtial from "../../Assets/images/digitalst.jpg"
export const ApplicationService = [
    {
        ...
        middle: "Insight Transformation",
        dis: "Insight to Transformation creates a digital strategy that defines your trajectory for transformation and accelerates value creation. We have re-envisioned the strategy process from a digitally native perspective to gain velocity and deliver a game-changing strategy",
    ...
    },
    {
        ...
        middle: "Managed Innovation",
        dis:"Our Managed Innovation capability uses an insight-driven, agile working process to prioritize and rapidly develop client solutions, delivering new forms of value. To ensure continuity, our program establishes, nurtures and grows an innovation capability within the organization"
...
export const Digitalstrategy = () => {
    return (
        ...
        <Container fluid style={{ marginBottom: '130px' }}>
                <div className="e-conn-full" style={{backgroundImage:`url(${digtial})`,backgroundRepeat:"no-repeat",backgroundSize:"100%"}}>
                    <Container>
            ...
            <Container style={{ marginBottom: '130px'}}>
                <Row className="align-items-center">
                    <Col md={12}>
                       <h2 style={{fontWeight:"bold", fontSize:"3em"}}>The right approach to digital strategy

</h2><br></br>

<div style={{fontSize:"1.4em"}}>

<p>As digital tools proliferate, so too do the number of customer demands and internal pressure to deliver digital-ready products and services.</p><br></br>
<p>Implementing an effective digital strategy across front-, middle- and back-office IT environments is crucial to staying relevant. Yet, the urgent need to create and act on a digital strategy gives rise to a host of complex problems that enterprises must sort out quickly—or risk falling behind.</p><br></br>
<p>We help clients set strategies in motion that unify business and technology architectures, generate growth and enable competitive advantage.</p><br></br>
</div>
                ...
                <Row>
                    <Col md={7} className="mx-auto">
                        <div className="smallheading text-center mb-5">
                            ...
                            <p>
                            Accelerating the shift to digital with Expert Digital Web offerings makes the path clear and the process systematic. Our integrated digital solutions are custom-fit and empower clients to deliver game-changing impact.                            </p>
                        </div>
                    </Col>
